        ...
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="px-6 mb-4 lg:px-8 bg-white dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent dark:border-gray-700">
                    ...
                    <form method="POST" action="{{ route('instituteClass.update', $instituteClass->id) }}">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 gap-4 mt-4">
                            <div>
                                ...
                                <x-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name', $instituteClass->name)"/>
                            </div>

                            <div>
                                <x-label for="code" value="{{ __('Class Short Name') }}"/>
                                <x-input id="code" class="block mt-1 w-full" type="text" name="code" :value="old('code', $instituteClass->code)"/>
                            </div>
                            ...
                            <div>
                                ...
                                <select required name="active" id="active" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                                    ...
                                    <option value="1" {{ $instituteClass->active == 1 ? 'selected' : '' }}>Active</option>
                                    <option value="0" {{ $instituteClass->active == 0 ? 'selected' : '' }}>In-Active</option>
                                </select>
                            </div>
                        </div>
